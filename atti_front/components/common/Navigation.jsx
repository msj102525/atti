                ...
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <nav className="space-x-4">
                        <ul className="flex space-x-4">
                            <li className={`${styles.customBrown} hover:text-customBrown transition-all duration-150 ease-in-out text-base font-semibold p-1`}>
                    ...
                    <div>
                        <li className={`${styles.customBrown} hover:text-customBrown transition-all duration-150 ease-in-out text-base font-semibold`}>
